...
package adpro.examFake.solutions
...
object Q3 {
  ...
  /* The selection of the fold is immaterial, due to associativity of the monoid
   **/
}
...
object Q4 {
  ...
  /**
   * This  is a  very  easy task  that just  checks  whether you  know
   * that  partiality  is modeled  using  Option  types in  functional
   * programming.
   */
...
object Question7 {
  ...
  /**
   * Task 10. Implement  a generator multipleOf10UpTo(m) that generaters integer
...
object Question8 {
  ...
  v1 :Gen[List[Int]]  // expected warning
  v2 :(List[Int],RNG) // expected warning
